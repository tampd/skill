...
3. **[MỚI] Cross-check với ACTIVE_CONTEXT.md** (nếu tồn tại):
   - Đọc section `⚠️ LESSONS ĐÃ ÁP DỤNG` trong ACTIVE_CONTEXT
   - Nếu LESSONS.md có bài học trùng với ACTIVE_CONTEXT → **ưu tiên cao nhất**
   - Phát hiện: đang lặp lại lỗi cũ trong cùng phiên → cảnh báo ngay:
     "🛑 BUG-XXX đã cảnh báo về vấn đề này trong phiên này rồi!"
